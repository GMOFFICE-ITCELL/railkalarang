...
// DB_PASSWORD=alMZlNV_Z?*p
    ...
    // Prepare and bind the SQL statement
      $stmt = $conn->prepare("UPDATE excess_Transaction_table SET merchant_id = ?, merchant_order_no = ?,transaction_failure_response = ?,transaction_status = ?,level = ? WHERE Order_number = ?");
